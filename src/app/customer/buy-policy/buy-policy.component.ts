...
export class BuyPolicyComponent implements OnInit {
  ...
  agents: any[] = [];
  fixedInsuranceSettingId: string = '141432a5-d5bb-ef11-a670-3024a9ee58f8';
  fixedTaxId: string = '79a8004c-d5bb-ef11-a670-3024a9ee58f8';
  schemeId: string = '';
  ...
  addPolicy() {
    ...
    const policyPayload = {
      ...
      taxId: '79a8004c-d5bb-ef11-a670-3024a9ee58f8', // Fixed taxId
      insuranceSettingId: '141432a5-d5bb-ef11-a670-3024a9ee58f8', // Fixed insuranceSettingId
